...
//  dif_motor_now = 87.32*dif_angle_y_now + 97.97*dif_angle_y_before - dif_motor_before;

// ELS BUENO(MAS O MENOS) 
//  dif_motor_now = 0.05 * dif_angle_y_now + 0.15 * dif_angle_y_before - 0.09 * dif_motor_before;
//  dif_motor_now = 0.05 * dif_angle_y_now + 0.15 * dif_angle_y_before - 0.09 * dif_motor_before;
  
//  dif_motor_now = 0.05 * dif_angle_y_now + 0.15 * dif_angle_y_before;

 // dif_motor_now = 0.40 * dif_angle_y_now - 0.10 * dif_angle_y_before;
//BUENO BUENO  dif_motor_now = 0.4 * dif_angle_y_now + 15.00 * (dif_angle_y_now-dif_angle_y_before);
//BUENO BUENO  dif_motor_now = 0.4 * dif_angle_y_now + 14.50 * (dif_angle_y_now-dif_angle_y_before);

  dif_motor_now = 0.48 * dif_angle_y_now + 16.00 * (dif_angle_y_now-dif_angle_y_before) + 0.0004 * error_y_accu;
  
//   dif_motor_now = 0.0004 * error_y_accu;
...
static void control_axis_x()
{
  ...
  dif_motor_x_now = 0.25 * dif_angle_x_now; // + 20.00 * (dif_angle_x_now-dif_angle_x_before) + 0.00000 * error_x_accu;
