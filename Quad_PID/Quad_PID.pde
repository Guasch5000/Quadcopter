...
static void control_axis_y()
{
  ...
  dif_motor_now = Kp_y * dif_angle_y_now + Kd_y * (dif_angle_y_now-dif_angle_y_before) + 0.00015 * error_y_accu;
...
static void control_axis_x()
{
  ...
  dif_motor_x_now = Kp_x * dif_angle_x_now + Kd_x * (dif_angle_x_now-dif_angle_x_before) + 0.00015 * error_x_accu;
